...
var InternalAuthClass = /** @class */ (function () {
    ...
    InternalAuthClass.prototype.handleAutoSignIn = function (username, password, validationData, clientMetadata, data) {
    ...
    InternalAuthClass.prototype.handleCodeAutoSignIn = function (authDetails) {
        var _this = this;
    ...
    InternalAuthClass.prototype.handleLinkAutoSignIn = function (authDetails) {
        var _this = this;
    ...
    InternalAuthClass.prototype.signInAfterUserConfirmed = function (authDetails, listenEvent, autoSignInPollingIntervalId) {
     ...
     */
    InternalAuthClass.prototype.authCallbacks = function (user, resolve, reject) {
        var _this = this;
        var that = this;
        return {
     ...
     */
    InternalAuthClass.prototype.signInWithPassword = function (authDetails) {
        var _this = this;
     ...
     * @return - A promise resolves the CognitoUser object if success or mfa required
     */
    InternalAuthClass.prototype.signInWithoutPassword = function (authDetails) {
        var _this = this;
        var user = this.createCognitoUser(authDetails.getUsername());
    ...
    InternalAuthClass.prototype._getUserData = function (user, params) {
        var _this = this;
        return new Promise(function (res, rej) {
            user.getUserData(function (err, data) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                var cleanUpError_2;
    ...
    InternalAuthClass.prototype.cleanUpInvalidSession = function (user) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var e_7;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
    ...
    InternalAuthClass.prototype._userSession = function (user) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
    ...
    InternalAuthClass.prototype.cognitoIdentitySignOut = function (opts, user) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
